...
## [0.31.2](https://github.com/asciidoc-rs/asciidoc-parser/compare/v0.31.1...v0.31.2)
_13 September 2026_

### Fixed

* Stop a panic on a spaced em dash between spans in a wrapped list item ([#1396](https://github.com/asciidoc-rs/asciidoc-parser/pull/1396))
...
* Record a debug-severity diagnostic for an unknown block style ([#1040](https://github.com/asciidoc-rs/asciidoc-parser/pull/1040))

### Fixed

* Demote the document title when block metadata precedes it ([#1038](https://github.com/asciidoc-rs/asciidoc-parser/pull/1038))

## [0.29.4](https://github.com/asciidoc-rs/asciidoc-parser/compare/v0.29.3...v0.29.4)
_01 August 2026_

### Fixed

* Strip a trailing `@` soft-set modifier from an API attribute value ([#1034](https://github.com/asciidoc-rs/asciidoc-parser/pull/1034))
