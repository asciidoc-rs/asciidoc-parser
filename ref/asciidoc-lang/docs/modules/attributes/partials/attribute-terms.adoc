Attribute reference:: An attribute reference marks the location where the information stored in the value of an attribute should be inserted when the document is converted.
...
Built-in attribute:: Built-in attributes are predefined and their names reserved.
...
Default attribute value:: Many built-in attributes have a default value.
...
User-defined attribute:: User-defined attributes are custom attributes that are created, set, and assigned a value by you.
