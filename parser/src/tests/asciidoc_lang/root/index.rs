...
track_file!("ref/asciidoc-lang/docs/modules/ROOT/pages/index.adoc");
...
The AsciiDoc language isn't coupled to the output produced from it.
The ability to produce multiple output formats is one of the main advantages of AsciiDoc.
This capability enables it to be used in static site generators, help text, book publishing, IDEs, git tools and services, CI/CD systems, and other novel uses.
