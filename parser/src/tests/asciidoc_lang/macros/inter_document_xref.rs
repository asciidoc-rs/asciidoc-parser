// Inter-document cross references are resolved by a host-supplied
// `ReferenceResolver` (see `crate::parser::reference_resolver`); the parser
// records them as deferred and leaves their resolution — including the
// relfilesuffix/relfileprefix path remapping described here — to the host.
// This page therefore describes host behavior and is mirrored as
// non-normative.
