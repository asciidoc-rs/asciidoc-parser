...
impl<'src> HasSpan<'src> for InlineNode<'src> {
    fn span(&self) -> Span<'src> {
        match self {
            ...
            Self::Styled(styled) => styled.location,
            Self::Ref(ref_) => ref_.location,
            Self::Image(image) => image.location,
            Self::Footnote(footnote) => footnote.location,
            Self::Anchor(anchor) => anchor.location,
            Self::Ui(ui) => ui.location,
            Self::IndexTerm(index_term) => index_term.location,
            Self::Callout(callout) => callout.location,
            Self::Stem(stem) => stem.location,
