...
* *FI* Should we continue support for angle bracket enclosure for explicit autolink? Yes, I think we should. They are a common web convention. They also help delinate the boundaries of a URL, though the example cited in the docs (of a replacement getting caught up in the URL) should no longer necessitate their use.
...
shorthand for targeting a blank window/new tab
...
should support shorthand for targeting a blank window/new tab like the link macro
...
* Roman numeral ordered list markers (can still be enabled in output using list style)
* Unicode bullet (U+2022) as unordered list marker
